  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "rounded-[14px] border-[0.5px]",
        "shadow-[inset_0_0_4px_0_rgba(0,0,0,0.03)]",
        "transition-[color,box-shadow,border-color] duration-[140ms] ease-out outline-none",
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          'shadow-[inset_0_0_4px_0_rgba(255,255,255,0.08),0_4px_24px_-4px_rgba(0,0,0,0.12)]',
          'dark:shadow-[inset_0_0_4px_0_rgba(255,255,255,0.03),0_4px_24px_-4px_rgba(0,0,0,0.4)]',
          'rounded-2xl',
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        /* Liquid Glass select item — rounded pill with fluid transitions */
        "focus:bg-accent/60 focus:text-accent-foreground",
        "[&_svg:not([class*='text-'])]:text-muted-foreground",
        "relative flex w-full cursor-default items-center gap-2 rounded-xl py-1.5 pr-8 pl-2 text-sm",
