...
export default async function Sintaks6Page() {
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2 pt-4">
              ...
              <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                <li>Mempresentasikan hasil proyek dengan baik</li>
                <li>Mendemonstrasikan fitur-fitur aplikasi</li>
                <li>Menjelaskan proses pengembangan</li>
                <li>Menjawab pertanyaan dan feedback</li>
              </ul>
            </div>
          </CardContent>
        </Card>
