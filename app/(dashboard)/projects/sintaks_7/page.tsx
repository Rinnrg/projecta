...
export default async function Sintaks7Page() {
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          {isGuruOrAdmin && (
            <Link href="/projects/add/sintaks_7">
              <Button>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Proyek Pemrograman Berorientasi Objek</h1>
          <p className="text-muted-foreground">Penilaian dan Evaluasi</p>
        </div>
        {isGuruOrAdmin && proyek && (
          <Link href="/projects/edit/sintaks_7">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2 pt-4">
              ...
              <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                <li>Memahami hasil penilaian proyek</li>
                <li>Mengidentifikasi kekuatan dan kelemahan</li>
                <li>Menerima feedback dari evaluasi</li>
                <li>Merencanakan perbaikan di masa depan</li>
              </ul>
            </div>
          </CardContent>
        </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button variant="secondary" className="w-full justify-start gap-2" asChild>
                <Link href={`/projects/sintaks_7/submit?proyekId=${proyek.id}`}>
