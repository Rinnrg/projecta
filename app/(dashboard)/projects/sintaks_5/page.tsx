...
export default async function Sintaks5Page() {
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          {isGuruOrAdmin && (
            <Link href="/projects/add/sintaks_5">
              <Button>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Proyek Pemrograman Berorientasi Objek</h1>
          <p className="text-muted-foreground">Pengumpulan Proyek</p>
        </div>
        {isGuruOrAdmin && proyek && (
          <Link href="/projects/edit/sintaks_5">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2 pt-4">
              ...
              <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                <li>Menyelesaikan dan mengumpulkan proyek akhir</li>
                <li>Memastikan semua fitur berfungsi dengan baik</li>
                <li>Melengkapi dokumentasi proyek</li>
                <li>Menyiapkan file yang akan dikumpulkan</li>
              </ul>
            </div>
          </CardContent>
        </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button variant="secondary" className="w-full justify-start gap-2" asChild>
                <Link href={`/projects/sintaks_5/submit?proyekId=${proyek.id}`}>
