    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          {isGuruOrAdmin && (
            <Link href="/projects/add/sintaks_4">
              <Button>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Proyek Pemrograman Berorientasi Objek</h1>
          <p className="text-muted-foreground">Monitoring Pelaksanaan</p>
        </div>
        {isGuruOrAdmin && proyek && (
          <Link href="/projects/edit/sintaks_4">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button variant="secondary" className="w-full justify-start gap-2" asChild>
                <Link href={`/projects/sintaks_4/submit?proyekId=${proyek.id}`}>
