...
export default async function Sintaks8Page() {
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2 pt-4">
              ...
              <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                <li>Merefleksikan proses pembelajaran</li>
                <li>Mengevaluasi pencapaian tujuan pembelajaran</li>
                <li>Mengidentifikasi lessons learned</li>
                <li>Merencanakan improvement untuk proyek selanjutnya</li>
              </ul>
            </div>
          </CardContent>
        </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button variant="secondary" className="w-full justify-start gap-2" asChild>
                <Link href={`/projects/sintaks_8/submit?proyekId=${proyek.id}`}>
