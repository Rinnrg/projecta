...
export default async function Sintaks2Page() {
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          {isGuruOrAdmin && (
            <Link href="/projects/add/sintaks_2">
              <Button>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Proyek Pemrograman Berorientasi Objek</h1>
          <p className="text-muted-foreground">Menyusun Rencana Proyek</p>
        </div>
        {isGuruOrAdmin && proyek && (
          <Link href="/projects/edit/sintaks_2">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2 pt-4">
              ...
              <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                <li>Menyusun rencana proyek yang terstruktur</li>
                <li>Membuat diagram kelas dan use case</li>
                <li>Menentukan kebutuhan sistem</li>
                <li>Merencanakan alur kerja proyek</li>
              </ul>
            </div>
          </CardContent>
        </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button variant="secondary" className="w-full justify-start gap-2" asChild>
                <Link href={`/projects/sintaks_2/submit?proyekId=${proyek.id}`}>
